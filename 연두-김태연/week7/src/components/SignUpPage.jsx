      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          <InputWrapper>
            ...
            />
            {(submitted && validateName(ID)) && <p style={{ color: 'red', fontSize: "15px" }}>{validateName(ID)}</p>}
        ...
        <LoginWrapper>
        <LoginText>이미 아이디가 있으신가요? <span style={{ color: '#fff', fontWeight: 'bold' }}>
        <Button as={Link} to="/Login" isActive={activeButton === 'Login'} onClick={() => handleButtonClick('Login')} >
        로그인 페이지로 이동하기
        </Button>
        </span></LoginText>
